...
if fig2:
    ...
    # for q,dd in enumerate(depth):
        ...
        # ss1 = 980+0.6e-3*(dd-140e3)
        # ss2 = 1090-178*(1-np.exp(-dd/8e3))
        # sss[q] = ss1
        # sss[q] = max(ss1,ss2)
    # lab5=axdep.plot(sss,depth/1e3,c='#FF9900',lw=5,label='solidus')
...
if fig3:    
    ...
    ax.vlines(x=650, ymin=0, ymax=600, colors='green', ls='-', lw=5,)
